...
public class MemberInfo_AgreementRewrite extends base{
	...
	@Test
	public void verifyRewriteButtonNavigation() {
		...
		Assert.assertTrue(ap.getSearchPlansWindow().isDisplayed());
		...
		((WebElement) ap.getWarningYesButtons().get(1)).click();
		
		MyActions.focusByNativeWindowHandleIndex(0);
		
		ap.getWarningYesButton().click();
		...
		ap.getDataChangedYesButton().click();
