...
public class CompeteAboutViewTest extends base {
	...
	public void CompeteAboutView() throws Exception {
		 ...
		 * 
		 * // NativeWindowHandle2 =
		 * a.getAboutPageLocator().getAttribute("NativeWindowHandle");
		 * NativeWindowHandle =
		 * driver.findElementByAccessibilityId("AboutView").getAttribute(
		 * "NativeWindowHandle"); int natWinHandleInt2 =
		 * Integer.parseInt(NativeWindowHandle2); String natWinHandleStr2 =
		 * Integer.toHexString(natWinHandleInt2); natWinHandle2 = "0x"+natWinHandleStr2;
		 ...
		 * appCapabilities2.setCapability("appTopLevelWindow", natWinHandle2); driver =
		 * new WindowsDriver<WindowsElement> (new URL("http://127.0.0.1:4723"),
		 * appCapabilities2); Thread.sleep(5000); System.out.println(driver.getTitle());
